function [solutionDel,solStatus] = ...
    linearMOMA(modelWT,modelDel,solWT,osenseStr,minFluxFlag,verbFlag)
...
% ///////// Philipp Edit: WT solution is added as input instead!!! ///////
% if (verbFlag)
